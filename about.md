...
3. The rest are some minor issues. For example, I didn't know how to do with Excel and the csv when encountering ISBN. When I opened csv with Excel and I made some changes to the file, it will automatically change the ISBN into an scientific approximation such as '9.7814E+12'. It creates trouble when I run the program in the csv. Another example would be I didn't make the printed version of the book information alighed according to different categories. In cases like these, I usually search online for the answers. As long as I can find the right words/terminologies to ask the question, I can often get what I needed. Patrick also helped me figure out some questions I needed to ask. 
